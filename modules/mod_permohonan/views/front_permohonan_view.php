...
?>
	...
	<form method="POST" action="<?php echo site_url(); ?>permohonan" enctype="multipart/form-data">
		...
		<table class="table-form" cellpadding="0" cellspacing="0" width="100%">
			<tbody>
				...
				<tr>
					<td colspan="4"><br/>Data dan informasi yang kami peroleh, akan kami gunakan sesuai dengan ketentuan perundang-undangan yang berlaku.<br/><br/></td>
				</tr>
				<tr>
	...
	<div align="right">
		<form action="<?php echo site_url(); ?>permohonan/edit/<?php echo intval(@$request['request_id']); ?>">
			<button type="submit" class="btn btn-info">Edit Permohonan</button>
		</form>
	</div>
</div>