...
--
-- Host: localhost
-- Generation Time: Oct 11, 2013 at 12:01 PM
...
CREATE TABLE IF NOT EXISTS `dinamic_complains` (
  ...
  `complain_nomor` varchar(100) DEFAULT NULL,
...
INSERT INTO `dinamic_complains` (`complain_id`, `complain_requestid`, `complain_reason`, `complain_case`, `complain_date`, `complain_datetime`, `complain_remoteip`, `complain_status`, `complain_status_reason`, `complain_nomor`) VALUES
(1, 5, '["2","3","5","7"]', 'sfds', '2013-10-05 01:04:04', '2013-10-05 00:41:41', NULL, 'Terselesaikan', 'susahnya', '2000'),
(2, 5, '["1","2","5"]', '', '2013-10-05 00:55:49', '2013-10-05 00:55:25', NULL, 'Terselesaikan', NULL, NULL),
(3, 5, '["4","5"]', '', '2013-10-06 17:19:55', '2013-10-06 17:19:31', NULL, 'Terselesaikan', 'hore', 'hihi'),
(4, 5, '["4","5"]', '', '2013-10-06 17:20:11', '2013-10-06 17:19:47', NULL, 'Baru', NULL, NULL),
(5, 5, '["1"]', '', '2013-10-06 17:33:02', '2013-10-06 17:32:38', NULL, 'Baru', NULL, NULL),
(6, 5, '["1","2"]', '', '2013-10-07 08:17:56', '2013-10-07 08:17:32', NULL, 'Diproses', '', '');
...
CREATE TABLE IF NOT EXISTS `dinamic_media` (
  ...
  `media_link` text,
  `media_title` varchar(250) DEFAULT NULL,
  `media_realname` text,
  ...
  `media_thumbnail` varchar(250) DEFAULT NULL,
...
INSERT INTO `dinamic_media` (`media_id`, `media_key`, `media_link`, `media_title`, `media_realname`, `media_category`, `media_status`, `media_userid`, `media_datetime`, `media_viewed`, `media_thumbnail`) VALUES
(1, 'download', '', 'Judul Informasi yang bisa diupload', 'BBM_for_Android-1.0_User_Guide-Beta.pdf', NULL, NULL, 1, '2013-10-11 10:47:36', NULL, ''),
(2, 'download', '', 'Data kelengkapan kerja', 'backEMF.docx', NULL, NULL, 1, '2013-10-11 10:47:39', 1, ''),
(3, 'galeri', '', '', 'Desert.jpg', NULL, NULL, 1, '2013-10-11 11:06:53', NULL, 'media/galeri/thumbnail/Desert.jpg'),
(4, 'galeri', '', '', 'Penguins.jpg', NULL, NULL, 1, '2013-10-11 11:07:41', NULL, 'media/galeri/thumbnail/Penguins.jpg');
...
INSERT INTO `dinamic_pollings` (`polling_id`, `polling_key`, `polling_name`, `polling_value`, `polling_status`) VALUES
(1, 'parent', 'nama\r\n', NULL, 'on'),
(2, '1', 'anama chilnsdf\r\n', NULL, NULL),
(3, '1', 'engasndfdf', NULL, NULL);
...
CREATE TABLE IF NOT EXISTS `dinamic_posts` (
  ...
  `post_static` varchar(10) DEFAULT NULL
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
...
INSERT INTO `dinamic_posts` (`post_id`, `post_userid`, `post_created`, `post_updated`, `post_title`, `post_content`, `post_short`, `post_status`, `post_commentstatus`, `post_commentcount`, `post_mimetype`, `post_expired`, `post_marquee`, `post_static`) VALUES
(6, 1, '2013-10-02 08:24:57', '2013-10-07 08:24:33', 'degan ini', 'kami meangatajd<br>', NULL, '1', '1', NULL, NULL, '0000-00-00 00:00:00', 'none', NULL),
(4, 1, '2013-10-02 16:57:14', NULL, 'nah!', 'Berita baru lain<br>', NULL, '1', '1', NULL, NULL, '0000-00-00 00:00:00', 'none', NULL),
(8, 1, '2013-10-08 06:17:46', NULL, 'ahisd', 'sad', NULL, '1', '1', NULL, NULL, '0000-00-00 00:00:00', 'none', '1'),
(9, 1, '2013-10-08 06:33:53', NULL, 'awerwer', 'wfawere', NULL, '1', '1', NULL, NULL, '0000-00-00 00:00:00', 'none', '1');

-- --------------------------------------------------------

--
-- Table structure for table `dinamic_rawdata`
--

CREATE TABLE IF NOT EXISTS `dinamic_rawdata` (
  `rawdata_id` bigint(20) NOT NULL,
  `rawdata_target` varchar(500) DEFAULT NULL,
  `rawdata_key` varchar(500) DEFAULT NULL,
  `rawdata_data` text,
  `rawdata_datetime` datetime DEFAULT NULL,
  `rawdata_remoteip` varchar(50) DEFAULT NULL,
  `rawdata_status` varchar(500) DEFAULT NULL,
  `rawdata_info` text,
  PRIMARY KEY (`rawdata_id`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1;

--
-- Dumping data for table `dinamic_rawdata`
--
...
(12, 14, '', '', '', '', '', '', '', '', '', '', 'permogh', '', 'langsung', 'tercetak', 'langsung', '2013-10-07 08:16:57', NULL, 'Baru', '', 'nomers');
...
(16, 'status_pengaduan', 'Diproses', 'diproses', NULL),
